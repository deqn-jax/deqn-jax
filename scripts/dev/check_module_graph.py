...
DRAWN_EDGES = {
    ...
    ("deqn_jax.cli", "deqn_jax.evaluate.irf"),
    ...
    ("deqn_jax.training", "deqn_jax.training.metrics"),
    ...
    ("deqn_jax.evaluate", "deqn_jax.evaluate.irf"),
    ("deqn_jax.evaluate.irf", "deqn_jax.training"),
    ("deqn_jax.evaluate.irf", "deqn_jax.models"),
    ("deqn_jax.evaluate.irf", "deqn_jax.config"),
}
