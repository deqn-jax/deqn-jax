...
(see \texttt{docs/disaster\_model\_errata.md}) and all four analytical
...
\subsection{Policy variables (8 network outputs)}

After four analytical eliminations ($s_t, L_t, c_t, \bar\omega_t$), the neural
network outputs:
\[
...
\textcolor{brown}{$c_t$} (consumption),
...
\textbf{8 controls and 8 equations}.
...
3 & $c_t$ (consumption) & Eq.~11 (resource constraint) & Direct solve \\
4 & $\bar\omega_t$ (default threshold) & Eq.~8 (bank participation) & Newton solver \\
\bottomrule
\end{tabular}
\end{center}
...
$c$          & 1.5937 & \textcolor{brown}{definition} \\
