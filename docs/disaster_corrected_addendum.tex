%==========================================================================
% HISTORICAL: this addendum was merged verbatim into disaster_corrected.tex
% (Sections 4-5 there). Kept for provenance only; disaster_corrected.tex is
% canonical. Two claims below were corrected there in the July 2026 audit
% (errata item 12): the ELB "~1e-7 SS distortion" holds only for the local
% wedge on R (equilibrium effect on solved pi_ss: -8e-5 in logs), and
% "R_taylor_ss = R_ss = 1.018" conflates the solved-SS rate (1.0180) with
% the R_ss constant (1.011678).
%==========================================================================
